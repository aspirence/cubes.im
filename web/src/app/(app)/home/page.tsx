...
export default function HomePage() {
  ...
  // Platform super-admins get a company-wide dashboard as their home; the
  // personal task dashboard stays one toggle away.
  const { data: isPlatformAdmin } = useIsPlatformAdmin();
  const [homeView, setHomeView] = useState<"company" | "mine">("company");
  const showCompany = Boolean(isPlatformAdmin) && homeView === "company";
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16, width: "100%" }}>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          {/* Super-admins switch between the company-wide view and their own work. */}
          {isPlatformAdmin ? (
            <Segmented
              value={homeView}
              onChange={(v) => setHomeView(v as "company" | "mine")}
              options={[
            ...
            <>
              ...
              <Dropdown
                ...
                menu={{
                  ...
                  onClick: ({ key }) => setRange(key as RangeKey),
                }}
              >
                <Button
                  icon={
